 ...
 *******************************************************************
 *
 * This template shows the history of a user's Easy Digital Downloads
 * purchases.
 *
 * @package Volatyl
 * @since Volatyl 1.2
...
//custom filters 
$download_history_info = apply_filters('download_history_info', array(
	'history_download_name'			=> 'Download Name',
	'history_files'					=> 'Files',
	'history_no_downloads_found'	=> 'No downloadable files found.',
	'history_no_purchases'			=> 'You have not purchased any downloads.'
	) 
);
	...
	<table id="edd_user_history">
		<thead>
			<tr class="edd_download_history_row">
				...
				<th class="edd_download_download_name"><?php _e($download_history_info['history_download_name'], 'volatyl'); ?></th>
				<?php if ( ! edd_no_redownload() ) { ?>
					<th class="edd_download_download_files"><?php _e($download_history_info['history_files'], 'volatyl'); ?></th>
				<?php } ?>
