	...
	<table id="edd_user_history">
		<thead>
			<tr class="edd_purchase_row">
				...
				<th class="edd_purchase_id"><?php _e('ID', 'volatyl'); ?></th>
				<th class="edd_purchase_date"><?php _e('Date', 'volatyl'); ?></th>
				<th class="edd_purchase_amount"><?php _e('Amount', 'volatyl'); ?></th>
				<th class="edd_purchased_files"><?php _e('Files', 'volatyl'); ?></th>
							...
							foreach ( $downloads as $download ) {
								...
								if ( ! edd_no_redownload() ) {
									if ( $download_files ) {
										...
										_e( 'No downloadable files found.', 'volatyl' );
									}
...
<?php else : ?>
	<p class="edd-no-purchases"><?php _e('You have not made any purchases', 'volatyl'); ?></p>
<?php endif;