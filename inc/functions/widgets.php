 ...
 *******************************************************************
 *
 * Register Volatyl widgetized areas (single post, page, and download sidebars
...
function vol_widgets_init() {
	...
	register_sidebar(array(
		...
		'id' 			=> 'sidebar-2',
		'description'   => __('In all layouts including two sidebars, this will be the right most sidebar (secondary).', 'volatyl'),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' 	=> '</aside>',
		'before_title' 	=> '<h4 class="widget-title">',
		'after_title' 	=> '</h4>',
