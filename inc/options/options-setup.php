...
function volatyl_content() {
	$vol_content = array(
		...
		'Default Widgets' 	=> array(
			...
			'td'			=> '<td>',
			'title'			=> 'widgets',
			'label'			=> __('Show default widget in empty sidebar areas.', 'volatyl'),
			'notes'			=> '<span class="notes">' . __('* The default widget does not show in fat footer widgetized areas because the columns will only display if an actual widget is used.', 'volatyl') . '</span>',
			'td_end'		=> '</td>',
			'tr_end'		=> '</tr>' 
		),
		'Pagination' 		=> array(
